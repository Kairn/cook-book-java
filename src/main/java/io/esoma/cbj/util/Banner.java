...
/**
 * Utility class for creating and managing banner strings. Banner strings are
 * used for marking the start and end of standard output content. Banner strings
 * make it easier for developers/testers to inspect the results of outputs.
 * 
 * @author Eddy Soma
 *
 */
