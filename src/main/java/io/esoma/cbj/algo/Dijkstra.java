...
/**
 * Class for illustrating Dijkstra's algorithm. This is an algorithm for finding the shortest paths
 * between nodes in a graph, and it was conceived by computer scientist Edsger W. Dijkstra in 1956.
 * Dijkstra's original algorithm found the shortest path between two given nodes, but a more common
 * variant fixes a single node as the source node and finds shortest paths from the source to all
