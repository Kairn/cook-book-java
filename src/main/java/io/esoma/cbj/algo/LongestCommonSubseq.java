...
/**
 * Class for studying the Longest Common Subsequence (LCS) problem. A
 ...
 * LCS of 2 sequences is a subsequence, with maximal length, which is common to
 * both the sequences.
 * 
 * @author Eddy Soma
 *
...
public class LongestCommonSubseq {
	...
	/**
	 * Computes the length of the LCS between the two given strings. It utilizes
	 * dynamic programming with a cache table for optimal performance. It will
