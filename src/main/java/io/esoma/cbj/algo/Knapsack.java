...
public class Knapsack {
	...
	/**
	 * A recursive function to generate the sums from all subsets of the given
	 * array.
	 * 
	...
	/**
	 * Searches through the sorted list to find the largest element that does not
	 * exceed the given limit. Returns 0 if all elements are larger than the limit.
	 * 
	 * @param list  the sorted input list
	 * @param limit the limit
	 * @return the largest element smaller or equal to the limit, or 0 if none is
	 *         found
	 */
