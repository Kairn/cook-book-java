...
/**
 * Class for implementing the Quick Sort algorithm. Quicksort is an efficient
 * sorting algorithm developed by British computer scientist Tony Hoare in 1959.
 ...
 * pivot. The sub-arrays are then sorted recursively. Efficient implementations
...
public class QuickSort {
	...
	/**
	 * Implements the original "Hoare partition scheme" where two indices are used
	 * check inversions and swap elements in the wrong order with the given pivot.
	 * The middle element is selected as pivot to increase efficiency for already
	 * sorted arrays. The array is sorted in-place.
	 * 
	...
	/**
	 * Performs swaps when inversion is detected with the pivot until the beginning
	 * index meets the ending index. Then returns the final index and repeats the
	 * process with sub-divisions.
	 * 
