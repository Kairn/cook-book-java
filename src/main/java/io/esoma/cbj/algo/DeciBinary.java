...
public class DeciBinary {
	 ...
	 * the decibinary system in its decimal format. Implementation uses dynamic
	 * programming to search for the decimal value of the target integer, and then
	 * computes each digit efficiently. This method is limited by predefined bounds
	...
	/**
	 * Computes how many decibinary numbers can have a particular decimal value up
	 * to a certain number of digits. The method is recursive and is fundamental to
	 * the DP nature of the main algorithm. With a reasonable bound, it efficiently
	 * finds the correct number of decibinary integers without resorting to
	 * enumeration.
	 * 
