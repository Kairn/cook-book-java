...
public class SingleByteXorCipher {
    ...
    public static void main(String[] args) {
        Logger.info(decryptMessage("1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736"));
    }
    ...
    public static SimpleCipherOutput<Character> decryptMessage(String encrypted) {
        ...
        for (int i = 0; i < encrypted.length(); i += 2) {
            String charBits =
                    HexUtil.hexCharToBits(encrypted.charAt(i)) + HexUtil.hexCharToBits(encrypted.charAt(i + 1));
