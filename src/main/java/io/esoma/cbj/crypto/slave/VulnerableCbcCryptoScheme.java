...
/**
 * An AES-128 crypto scheme that uses CBC mode, but it has an extra function that returns if the
 * cipher text has valid padding after decryption for the given IV, which makes it vulnerable to
