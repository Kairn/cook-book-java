...
/**
 * Class that implements a cryptographic scheme using AES-128 in CBC mode. It
 * always puts the user input in between some prefix and suffix before
 * encrypting, hence the name sandwich.
 * 
 * @author Eddy Soma
 *
 */
