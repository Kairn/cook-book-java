...
/**
 * Class that implements a slightly more complex AES-128 encryption scheme.
 * However, it still uses ECB mode, and therefore it is vulnerable to oracle
 * attacks. Besides having an unknown string appended at the end of each plain
 * text it receives, an stream of bytes of unknown size is prepended as well
 * before encryption.
 * 
 * @author Eddy Soma
 *
