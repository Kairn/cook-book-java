...
/**
 * Class that simulates an insecure user profile registration/login system that
 * encrypts information using AES-128 in ECB mode under a fixed key.
 * 
 * @author Eddy Soma
 *
 */
public class SillyUserProfileRegistrar {
	...
	/**
	 * Creates a standard user profile with a "USER" role for the given email
	 * address. "&" and "=" characters are not allowed.
	 * 
	...
	/**
	 * Decrypts and decodes the credentials and then retrieves the user profile
	 * behind it.
	 * 
