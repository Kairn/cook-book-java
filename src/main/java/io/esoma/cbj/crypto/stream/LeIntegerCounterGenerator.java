...
/**
 * Class that implements the {@link CounterGenerator} by enumerating integers with an incrementing
 * step of 1. Each integer is returned as an 8-byte array in little-endian mode. An exception will
 * be thrown if the counter >= {@link Long#MAX_VALUE}.
 *
 * @author Eddy Soma
 */
