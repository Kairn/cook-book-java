...
/**
 * Class for exploring the AES-128 encryption scheme in CBC mode. This is pseudo hand-written
 * implementation of the algorithm, as it leverages the {@link AesInEcb} class to do the low-level
 * operations.
 *
 * @author Eddy Soma
 */
public class AesInCbc {
  ...
  /**
   * Decrypts a stream of cipher bytes with AES-128 in CBC mode when the key is known.
   *
