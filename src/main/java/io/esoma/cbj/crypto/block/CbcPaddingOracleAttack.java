 ...
 * repeatedly sending tampered cipher text to the decryption engine and see if the padding is valid.
 * The expected padding byte is somewhat obvious to the attacker once it is valid, and therefore the
 * plain text byte is revealed by performing an XOR between the padding byte and the cipher text
 * byte.
 *
 * @author Eddy Soma
 */
