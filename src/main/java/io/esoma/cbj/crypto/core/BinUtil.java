...
public class BinUtil {
    ...
    /**
     * Encodes an integer value into a stream of bits. Padding of "0"s will be applied to ensure the
     * resulting string has a length equal to the specified number of bits. Negative values are not
     * supported.
     *
