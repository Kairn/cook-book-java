...
class ArrayCoreTest {
    ...
    void testLinearSearchInt3() {
        int[] array = new int[] {
            4119, 2927, 4017, 3787, 2025, 2444, 2358, 3845, 2979, 3085, 4030, 2844, 2237, 3656, 3581, 3581
        };
        int target = 3581;
        int expected = 14;
        int actual = ArrayCore.linearSearchInt(array, target, 0, array.length - 1);
    ...
    void testReverseInt1() {
        int[] straight = new int[] {
            257, 282, 284, 304, 317, 351, 353, 360, 368, 374, 410, 428, 476, 501, 525, 553, 568, 582, 603, 621, 624, 654
        };
        int[] reverse = new int[] {
            654, 624, 621, 603, 582, 568, 553, 525, 501, 476, 428, 410, 374, 368, 360, 353, 351, 317, 304, 284, 282, 257
        };
    ...
    void testInsertInt1() {
        int[] old =
                new int[] {5, 8, -9, 0, -7, 3, 3, 1, 0, 2, -6, -9, 7, 9, -3, 2, -1, -6, 1, -8, -5, -8, -6, -4, 1, -3};
        int[] inserted =
                new int[] {5, 8, -9, 0, -7, 3, 3, 0, 2, -6, -9, 7, 1, 9, -3, 2, -1, -6, 1, -8, -5, -8, -6, -4, 1, -3};
    ...
    void testInsertInt2() {
        ...
        int[] inserted = new int[] {645, 842, 953, 942, 709, 120, 93, 685, 813, 399, 341, 540, 574, 920, 283, 45, 474};
    ...
    void testCheckIntAsc1() {
        int[] array = new int[] {
            1, 2, 4, 5, 5, 6, 6, 8, 8, 8, 8, 9, 9, 10, 11, 12, 14, 16, 18, 19, 21, 21, 23, 23, 24, 24, 25, 26, 27, 28,
            28, 28, 31, 32, 34, 35, 36, 37, 37, 37, 39, 40, 40, 42, 43, 44, 45, 46, 46, 46, 46, 47, 47, 49, 53, 55, 56,
            57, 58, 58, 60, 63, 63, 64, 65, 65, 66, 66, 70, 71, 72, 72, 72, 73, 73, 74, 77, 78, 78, 80, 80, 80, 81, 81,
            82, 82, 82, 85, 86, 89, 89, 90, 92, 94, 95, 95, 96, 96, 98, 100
        };
    ...
    void testCheckIntAsc2() {
        int[] array = new int[] {
            99, 1009, 40, 40, 40, 40, 41, 42, 43, 43, 44, 44, 45, 45, 46, 47, 48, 48, 48, 49, 49, 50, 5080, 90, 50
        };
    ...
    void testCheckIntAsc3() {
        int[] array = new int[] {
            684, 684, 685, 692, 703, 708, 710, 713, 720, 766, 777, 884, 802, 804, 813, 817, 823, 826, 878, 902, 902,
            906, 908, 909, 932, 934, 936, 942, 987, 996
        };
