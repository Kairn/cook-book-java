...
public class BinaryInsertionSortTest {
	...
	public void testSortOnline1() throws Exception {
		int[] unsorted = new int[] { 132, 412, 694, 898, 376, 575, 25, 653, 502, 887, 375, 204, 270, 945, 842, 770, 881,
				34, 488, 773, 981, -36 };
		int[] sorted = new int[] { -36, 25, 34, 132, 204, 270, 375, 376, 412, 488, 502, 575, 653, 694, 770, 773, 842,
				881, 887, 898, 945, 981 };
		BinaryInsertionSort.sortOnline(unsorted, 0, unsorted.length - 1, 0);
		Printer.printIntArray(unsorted, ' ');
	...
	public void testSortOnline4() throws Exception {
		int[] unsorted = new int[] { 1, 2, 2, 4, 3, 3, 13, 14, 14, 5, 7, 5, 5, 13, 13, 4, 13, 4, 2, 4, 8, 12, 13, 14,
				4 };
	...
	public void testSortOnline6() throws Exception {
		int[] unsorted = new int[] { 33735, 35433, 35749, 34310, 35516, 35449, 34072, 34284, 34156, 34963, 35199, 33815,
				33626, 33723, 33595, 35316 };
		int[] sorted = new int[] { 33595, 33626, 33723, 33735, 33815, 34072, 34156, 34284, 34310, 34963, 35199, 35316,
				35433, 35449, 35516, 35749 };
		BinaryInsertionSort.sortOnline(unsorted, 0, unsorted.length - 1, 0);
		Printer.printIntArray(unsorted, ' ');
		assertArrayEquals(sorted, unsorted);
	}
	...
	public void testSortOnline7() throws Exception {
		int[] unsorted = new int[] { -24, 68, -66, -67, 48, -53, -51, -48, -49, -74, 54, 51, -47, -45, 56, 59, 69,
				-47 };
