...
class AvlTreeTest {
    ...
    void testToSortedList() {
        int[] array = new int[] {
            56, 94, 80, 88, 23, 5, 0, 68, 49, 60, 15, 66, 12, 35, -3, 69, 89, 12, 46, 11,
            24, -5, 86, 5, 33, 5, 86, 52, 48, 76, 4, 55, 15, 51, 102, 67, 8, 103, 92, 84,
            92, 38, 48, 57, 13, 15, 49, 87, 13, 24, 104, 19, 41, 73, -3, 4, 5, 79, 15, 82,
            62, 92, -2, 83, 40, 33, 101, 104, 73, 46, 47, 8, 62, 29, 90, 9, 85, 89, 85, 31,
            16, 100, 34, 4, 5, 74, 42, 40, 37, 49, 89, 32, 5, 96, 36, 73, 31, 63, 42, 68
        };
        for (int a : array) {
            avt.insert(a);
        }
