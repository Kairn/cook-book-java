...
public class QuickSortTest {
	...
	public void testSort3() throws Exception {
		int[] unsorted = new int[] { 326, -3, 21, 253, -159, 226, -286, -254, -191, 379, 242, -178, 171, 66, 28, 74,
				329, -230 };
		int[] sorted = new int[] { -286, -254, -230, -191, -178, -159, -3, 21, 28, 66, 74, 171, 226, 242, 253, 326, 329,
				379 };
		int[] result = QuickSort.sort(unsorted);
		Printer.printIntArray(result, ' ');
		assertArrayEquals(sorted, result);
