...
class MergeSortTest {
    ...
    void testSort10() {
        int[] unsorted = new int[] {
            7457339, 7460627, 7458844, 7458590, 7463229, 7458481, 7461115, 7461846, 7456149,
            7463483, 7458673, 7459154, 7461161, 7457257, 7460370, 7459580, 7458513, 7458656,
            7457518
        };
        int[] sorted = new int[] {
            7456149, 7457257, 7457339, 7457518, 7458481, 7458513, 7458590, 7458656, 7458673,
            7458844, 7459154, 7459580, 7460370, 7460627, 7461115, 7461161, 7461846, 7463229,
            7463483
        };
        int[] result = MergeSort.sort(unsorted);
        Logger.debug(Arrays.toString(unsorted));
